...
protocol SearchTableTableViewControllerDelegate{
...
class SearchTableTableViewController: UITableViewController {
    ...
    var delegate : SearchTableTableViewControllerDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let selectedStock = stocksFromSearch?[indexPath.row]{
            delegate?.SearchTableTableViewControllerDidFinishWith(stock: selectedStock)
        }
